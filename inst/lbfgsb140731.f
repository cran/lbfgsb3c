...
c-jlm-jn 
     ...
     +          lwy,lsy,lss,lwt,lwn,lsnd
      ...
      write(6,*) '  The incoming task no. is ', itask
      if ((itask .lt. 1) .or. (itask .gt. 26)) stop(999)
c      if (task .eq. 'START') then
     ...
     +  icsave,lsave,isave(22),dsave)
      ...
      write(6,*) " itask on return is ",itask
...
c      if (n .le. 0) task = 'ERROR: N .LE. 0'
       if (n .le. 0) then
           write (6, *) '  ERROR: N .LE. 0'
           stop
       endif
c      if (m .le. 0) task = 'ERROR: M .LE. 0'
       if (m .le. 0) then
           write (6, *) '  ERROR: M .LE. 0'
           stop
       endif

c      if (factr .lt. zero) task = 'ERROR: FACTR .LT. 0'
       if (factr .le. zero) then
           write (6, *) '  ERROR: FACTR .LT. 0'
           stop
       endif
